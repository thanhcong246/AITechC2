...
import static com.vn.tcshop.aitechc.ChatBlog.chatwindoActivity.reciverIImg;
import static com.vn.tcshop.aitechc.ChatBlog.chatwindoActivity.senderImg;
...
public class messagesBlogAdpter extends RecyclerView.Adapter {
    Context context;
    ArrayList<msgModelclass> messagesAdpterArrayList;
    int ITEM_SEND=1;
    int ITEM_RECIVE=2;

    public messagesBlogAdpter(Context context, ArrayList<msgModelclass> messagesAdpterArrayList) {
